/*
 * A class for the graphical user interface of the game.
 * Includes all needed methods and attributes relating the user interface.
 * Uses the Gameboard and Numbertile classes and image files from
 * the Resources folder. The game instructions and details are explained
