/*
 * A class for the gameboard object. The core of the game.
 * Includes needed methods and attributes for the game functionality,
 * which the Mainwindow can use. Uses the Numbertile class.
 *
 * Nimi: Teemu Salonen
